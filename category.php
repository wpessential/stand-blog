<?php
get_header();
$banner_show = get_theme_mod('category_banner_display_setting');
$banner_title = get_theme_mod('category_title_setting');
$banner_subtitle = get_theme_mod('category_subtitle_setting');
$banner_image = get_theme_mod('category_background_setting');
                            ...
                            <div class="col-lg-6">
                                <div class="blog-post">
                                    ...
                                    <div class="down-content">
                                        <?php if (true == get_theme_mod('category_category_setting')) { ?>
                                            <span>
                                                <?php the_category(', '); ?>
                                            </span>
                                        <?php } ?>
                                        ...
                                        <ul class="post-info">
                                            <?php if (true == get_theme_mod('category_author_setting')) { ?>
                                                <li>
                                            ...
                                            <?php } ?>
                                            <?php if (true == get_theme_mod('category_post_date_setting')) { ?>
                                                <li>
                                                    <a
                                            ...
                                            <?php } ?>
                                            <?php if (true == get_theme_mod('category_post_comments_setting')) { ?>
                                                <li><a href="#">
                                        ...
                                        <div class="post-options">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <ul class="post-tags">
                                                        <?php if (true == get_theme_mod('category_tags_setting')) { ?>
