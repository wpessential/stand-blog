<?php do_action( 'wpe_before_comment_list' ); ?>
    <<?php echo apply_filters( 'wpe/comment/list/tag', 'ul' ); ?> class="<?php echo apply_filters( 'wpe/comment/list/classes', 'comment-list' ); ?>">
<?php
wp_list_comments(
	apply_filters(
		...
		[
			...
			'style'       => apply_filters( 'wpe/comment/style', 'ul' ),
...
?>
    </<?php echo apply_filters( 'wpe/comment/list/tag', 'ul' ); ?>>
<?php
