...
$banner_show = get_theme_mod('tag_banner_display_setting');
$banner_title = get_theme_mod('tag_title_setting');
$banner_subtitle = get_theme_mod('tag_subtitle_setting');
$banner_image = get_theme_mod('tag_background_setting');
                        ...
                        <?php while (have_posts()):
                            ...
                            <div class="col-lg-6">
                                <div class="blog-post">
                                    ...
                                    <?php if(true== get_theme_mod('tag_category_setting')){ ?>
                                        <span>
                                            <?php the_category(', '); ?>
                                        </span>
                                        <?php } ?>
                                        ...
                                        <ul class="post-info">
                                        <?php if(true== get_theme_mod('tag_author_setting')){ ?>
                                            <li>
                                            ...
                                            <?php } ?>
                                            <?php if(true== get_theme_mod('tag_post_date_setting')){ ?>
                                            <li>
                                                <a
                                            ...
                                            <?php } ?>
                                            <?php if(true== get_theme_mod('tag_post_comments_setting')){ ?>
                                            <li><a href="#">
                                        ...
                                        <div class="post-options">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <ul class="post-tags">
                                                    <?php if(true== get_theme_mod('tag_tags_setting')){ ?>
