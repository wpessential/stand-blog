...
<section class="contact-us">
      <div class="container">
        <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="sidebar-item contact-information">
                    <div class="sidebar-heading">
                      <h2><?php echo esc_html($contactbar_heading); ?></h2>
                    </div>
                    <div class="content">
                      <ul>
                        <li>
                        ...
                        <li>
                          ...
                          <span><?php echo esc_html($address_label); ?></span>
                        </li>
                      </ul>
                    </div>
                  </div>
          ...
          <div class="col-lg-12">
            <div id="map">
              <iframe src=" <?php echo esc_url($map_link);?>" width="100%" height="450px" frameborder="0" style="border:0" allowfullscreen=""></iframe>
              <?php print_r($map_link);?>
            </div>
          </div>
        </div>
      </div>
