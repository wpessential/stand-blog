...
new \Kirki\Field\Checkbox_Switch(
	[
		'settings'    => 'author_banner_display_setting',// saves values in the database ,serves as ID
		'label'       => esc_html__( 'Banner Show', 'standblog' ),
		'description' => esc_html__( 'Switch On and OFF  to show and hide the banner', 'standblog' ),
		'section'     => 'author_section',// id of the section in whicg u want to include this control
		'default'     => 'on',
		'choices'     => [ 
...
new \Kirki\Field\Image(
	[
		'settings'    => 'author_background_setting',// saves values in the database ,serves as ID
        ...
        'active_callback' => [
            [
                'setting'  => 'author_banner_display_setting', // uss contol ki id jis sa app present control (Background ki id 'background_setting ' ko relate karna chahta hain)
                'operator' => '==',
...
new \Kirki\Field\Text(
    [
        'settings' => 'author_title_setting',// saves values in the database ,serves as ID
        ...
        'active_callback' => [// Serves as condition if true then proceed same as if(){ ....}
            [
                'setting'  => 'author_banner_display_setting',//  jis cntrol sa link karna chahta hain uss ki id
                'operator' => '==',
                'value'    => 1,// jis value par ap iss conrrol ko link karna chahta hain
            ]
        ],
...
new \Kirki\Field\Text(
    [
        'settings' => 'author_subtitle_setting',// saves values in the database ,serves as ID
...
new \Kirki\Field\Checkbox_Switch(
	[
		'settings'    => 'author_category_setting',// saves values in the database ,serves as ID
...
new \Kirki\Field\Checkbox_Switch(
	[
		'settings'    => 'author_setting',// saves values in the database ,serves as ID
...
new \Kirki\Field\Checkbox_Switch(
	[
		'settings'    => 'author_post_date_setting',// saves values in the database ,serves as ID
...
new \Kirki\Field\Checkbox_Switch(
	[
		'settings'    => 'author_post_comments_setting',// saves values in the database ,serves as ID
...
new \Kirki\Field\Checkbox_Switch(
	[
		'settings'    => 'author_tags_setting',// saves values in the database ,serves as ID
