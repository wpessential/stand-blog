...
new \Kirki\Field\Checkbox_Switch(
	[
		'settings'    => 'blog_banner_display_setting',// saves values in the database ,serves as ID
...
new \Kirki\Field\Text(
    [
        'settings' => 'blog_title_setting',// saves values in the database ,serves as ID
        ...
        'active_callback' => [// Serves as condition if true then proceed same as if(){ ....}
            [
                'setting'  => 'blog_banner_display_setting',//  jis cntrol sa link karna chahta hain uss ki id
                'operator' => '==',
                'value'    => 1,// jis value par ap iss conrrol ko link karna chahta hain
            ]
        ],
...
new \Kirki\Field\Text(
    [
        'settings' => 'blog_subtitle_setting',// saves values in the database ,serves as ID
...
new \Kirki\Field\Checkbox_Switch(
	[
		'settings'    => 'blog_category_setting',// saves values in the database ,serves as ID
...
new \Kirki\Field\Checkbox_Switch(
	[
		'settings'    => 'blog_author_setting',// saves values in the database ,serves as ID
...
new \Kirki\Field\Checkbox_Switch(
	[
		'settings'    => 'blog_post_date_setting',// saves values in the database ,serves as ID
...
new \Kirki\Field\Checkbox_Switch(
	[
		'settings'    => 'blog_post_comments_setting',// saves values in the database ,serves as ID
		'label'       => esc_html__( 'Show Comments Number', 'standblog' ),
		'description' => esc_html__( 'Switch On and OFF  to show and hide Commnts Number on post ', 'standblog' ),
		'section'     => 'blog_section',// id of the section in whicg u want to include this control
		'default'     => 'on',
		'choices'     => [ 
