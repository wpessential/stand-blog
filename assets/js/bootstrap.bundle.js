...
! function ( e, t ) {
	...
	function Ze( e, t ) {
		var n = 2 < arguments.length && void 0 !== arguments[ 2 ] && arguments[ 2 ], i = Fe( 10 ),
			r                                                                          = "HTML" === t.nodeName, o                                               = Je( e ), s = Je( t ), a = je( e ), l = Pe( t ),
	...
	function $e( e, t, n, i ) {
		...
		if ( "viewport" === i ) o = function ( e ) {
			var t                                                          = 1 < arguments.length && void 0 !== arguments[ 1 ] && arguments[ 1 ],
				n                                                          = e.ownerDocument.documentElement, i = Ze( e, n ),
				r                                                          = Math.max( n.clientWidth, window.innerWidth || 0 ),
				o = Math.max( n.clientHeight, window.innerHeight || 0 ), s = t ? 0 : Be( n ),
				a                                                          = t ? 0 : Be( n, "left" );
		...
		placement: "bottom", positionFixed: ! 1, eventsEnabled: ! 0, removeOnDestroy: ! 1, onCreate: function () {
			...
			shift: {
				...
				order: 500, enabled: ! 0, fn: function ( e, t ) {
					...
					var m                                          = a[ f ] + a[ c ] / 2 - p / 2, g         = Pe( e.instance.popper ),
						_ = parseFloat( g[ "margin" + u ], 10 ), v = parseFloat( g[ "border" + u + "Width" ], 10 ),
				...
				order: 600, enabled: ! 0, fn: function ( p, m ) {
					...
					return E.forEach( function ( e, t ) {
						...
						var n, i = p.offsets.popper, r = p.offsets.reference, o = Math.floor,
							...
							a                                                   = o( i.left ) < o( g.left ), l = o( i.right ) > o( g.right ),
							c                                                   = o( i.top ) < o( g.top ), u                      = o( i.bottom ) > o( g.bottom ),
				...
				order: 850, enabled: ! 0, fn: function ( e, t ) {
					...
					var s = void 0 !== o ? o : t.gpuAcceleration, a = Je( We( e.instance.popper ) ),
						...
						h                                           = lt( "transform" ), d = void 0, p        = void 0;
		...
		Bi          = ( St = "dropdown", At = "." + ( Dt = "bs.dropdown" ), It = ".data-api", Ot = ( Tt = t ).fn[ St ], Nt = new RegExp( "38|40|27" ), kt = {
			...
			return e.toggle = function () {
				...
				if ( ! e || 3 !== e.which && ( "keyup" !== e.type || 9 === e.which ) ) for ( var t = [].slice.call( document.querySelectorAll( Wt ) ), n = 0, i = t.length; n < i; n++ ) {
					var r = c._getParentFromElement( t[ n ] ), o = Tt( t[ n ] ).data( Dt ),
						s                                        = { relatedTarget: t[ n ] };
